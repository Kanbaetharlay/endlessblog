...
<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $team_member->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            @la_access("Team_Members", "edit")
                <a href="{{ url(config('laraadmin.adminRoute') . '/team_members/'.$team_member->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
            
            @la_access("Team_Members", "delete")
                {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.team_members.destroy', $team_member->id], 'method' => 'delete', 'style'=>'display:inline']) }}
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/team_members') }}" data-toggle="tooltip" data-placement="right" title="Back to Team Members"><i class="fa fa-chevron-left"></i></a></li>
            ...
            <div class="tab-content">
                <div class="panel infolist">
                    ...
                    <div class="panel-body">
						...
						@la_display($module, 'skill')
						@la_display($module, 'member_position')
