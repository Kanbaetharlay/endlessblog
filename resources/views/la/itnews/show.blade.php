...
<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $itnews->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            @la_access("ITNews", "edit")
                <a href="{{ url(config('laraadmin.adminRoute') . '/itnews/'.$itnews->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
            
            @la_access("ITNews", "delete")
                {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.itnews.destroy', $itnews->id], 'method' => 'delete', 'style'=>'display:inline']) }}
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/itnews') }}" data-toggle="tooltip" data-placement="right" title="Back to ITNews"><i class="fa fa-chevron-left"></i></a></li>
